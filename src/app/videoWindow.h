...
private:
    ...
    void updateActionGroup(QActionGroup *channelActions, const QList<ChannelDescription> &availableChannels, Func actionSlot);
...
static inline VideoWindow *engine()
{
    return VideoWindow::s_instance;
}
static inline VideoWindow *videoWindow()
{
    return VideoWindow::s_instance;
}
}
