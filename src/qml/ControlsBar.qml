...
OverlayPopup {
    ...
    contentItem: GridLayout {
        rows:toolbar.stackedMode ? 2 : 1
        columns: toolbar.stackedMode ? 3 : 4
        columnSpacing: toolbar.stackedMode ? 0 : Kirigami.Units.largeSpacing * 4
        ...
        Item {
            Layout.fillWidth: toolbar.stackedMode
            Layout.preferredHeight: childrenRect.height
            Layout.preferredWidth: toolbar.stackedMode ? -1 :  childrenRect.width
            Layout.alignment: Qt.AlignVCenter

            RowLayout {
                anchors {
                    horizontalCenter: parent.horizontalCenter
                    // left: toolbar.stackedMode ? undefined : parent.left
                    // right: toolbar.stackedMode ? undefined : parent.right
                    horizontalCenterOffset: toolbar.stackedMode ? toolbar.leftRightOffset : 0
                }
                spacing: Kirigami.Units.smallSpacing
