...
Kirigami.ApplicationWindow {
    ...
    property Dialogs.FileDialog fileDialog: Dialogs.FileDialog {
        currentFolder: Core.StandardPaths.standardLocations(Core.StandardPaths.MoviesLocation)[0]
        onAccepted: {
            playerPage.player.source = selectedFile
    ...
    property Kirigami.Action openAction: Kirigami.Action {
        ...
        onTriggered: appWindow.fileDialog.open()
        tooltip: text
    }
